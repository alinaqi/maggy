...
73 skills, TDD enforcement, quality gates, security rules, and agent teams. Works with Claude Code, Codex CLI, Kimi CLI, and Gemini CLI.
...
| Layer | What it does |
|-------|-------------|
| **73 skills** | Python, TypeScript, React, React Native, Flutter, Android, Supabase, Firebase, Stripe, Shopify, and more |
